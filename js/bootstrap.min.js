...
document.querySelectorAll('#product-gallery .carousel-inner img, .post-content img').forEach((el) => el.addEventListener('click', (e) => {
	e.preventDefault();
	console.log(el);
